 ...
 */ ?>
        ...
        <ul class="ccm-search-form-advanced list-inline">
            ...
            if ($fp->canAddFile()) { ?>
                <li class="ccm-file-manager-show-dialog ccm-file-manager-upload"><a href="javascript:void(0);"><?php echo t('Upload Files')?><input type="file" name="files[]" multiple="multiple" /></a></li>
